...
type downloadTester struct {
	...
	stateDb aysdb.Database // Database used by the tester for syncing from peers
	peerDb  aysdb.Database // Database of the peers containing all data
...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", ays.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", ays.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", ays.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", ays.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want ays.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", ays.SyncProgress{
