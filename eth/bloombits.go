...
type BloomIndexer struct {
	...
	db      aysdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db aysdb.Database, size, confirms uint64) *core.ChainIndexer {
