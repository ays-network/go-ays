...
func (db *Database) NewBatch() aysdb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) aysdb.Iterator {
...
func (b *batch) Replay(w aysdb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  aysdb.KeyValueWriter
	failure error
}
