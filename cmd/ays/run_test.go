...
import (
	...
	"github.com/ays/go-ays/internal/cmdtest"
	"github.com/ays/go-ays/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "ays-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "ays-test" in runGeth.
	reexec.Register("ays-test", func() {
...
// spawns ays with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGeth(t *testing.T, args ...string) *testays {
	tt := &testays{}
	...
	// Boot "ays". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("ays-test", args...)
