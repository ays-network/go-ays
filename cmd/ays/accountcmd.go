...
var (
	walletCommand = cli.Command{
		...
		Description: `
    ays wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	ays wallet [options] /path/to/my/presale.wallet
...
between ays nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    ays account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    ays account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another ays instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := aysConfig{Node: defaultNodeConfig()}
	// Load config file.
