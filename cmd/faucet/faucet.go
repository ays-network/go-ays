...
var (
	...
	statsFlag   = flag.String("aystats", "", "Ethstats network monitoring auth string")
...
type faucet struct {
	...
	client *aysclient.Client   // Client connection to the Ethereum chain
...
func newFaucet(genesis *core.Genesis, port int, enodes []*discv5.Node, network uint64, stats string, ks *keystore.KeyStore, index []byte) (*faucet, error) {
	...
	// Assemble the aystats monitoring and reporting service'
	if stats != "" {
		if err := aystats.New(stack, lesBackend.ApiBackend, lesBackend.Engine(), stats); err != nil {
			return nil, err
		}
	}
	...
	client := aysclient.NewClient(api)
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/ays/go-ays/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
