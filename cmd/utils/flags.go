...
// Package utils contains internal helper functions for go-ays commands.
package utils
...
import (
	...
	"github.com/ays/go-ays/accounts"
	"github.com/ays/go-ays/accounts/keystore"
	"github.com/ays/go-ays/common"
	"github.com/ays/go-ays/common/fdlimit"
	"github.com/ays/go-ays/consensus"
	"github.com/ays/go-ays/consensus/clique"
	"github.com/ays/go-ays/consensus/ethash"
	"github.com/ays/go-ays/core"
	"github.com/ays/go-ays/core/rawdb"
	"github.com/ays/go-ays/core/vm"
	"github.com/ays/go-ays/crypto"
	"github.com/ays/go-ays/eth"
	"github.com/ays/go-ays/eth/downloader"
	"github.com/ays/go-ays/eth/gasprice"
	"github.com/ays/go-ays/aysdb"
	"github.com/ays/go-ays/aystats"
	"github.com/ays/go-ays/graphql"
	"github.com/ays/go-ays/internal/ethapi"
	"github.com/ays/go-ays/internal/flags"
	"github.com/ays/go-ays/les"
	"github.com/ays/go-ays/log"
	"github.com/ays/go-ays/metrics"
	"github.com/ays/go-ays/metrics/exp"
	"github.com/ays/go-ays/metrics/influxdb"
	"github.com/ays/go-ays/miner"
	"github.com/ays/go-ays/node"
	"github.com/ays/go-ays/p2p"
	"github.com/ays/go-ays/p2p/discv5"
	"github.com/ays/go-ays/p2p/enode"
	"github.com/ays/go-ays/p2p/nat"
	"github.com/ays/go-ays/p2p/netutil"
...
var (
	...
	EthStatsURLFlag = cli.StringFlag{
		Name:  "aystats",
		Usage: "Reporting URL of a aystats service (nodename:secret@host:port)",
	}
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `ays account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/ays/whisper")
	}
}
...
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := aystats.New(stack, backend, backend.Engine(), url); err != nil {
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "ays.", tagsMap)
		}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) aysdb.Database {
	var (
		cache   = ctx.GlobalInt(CacheFlag.Name) * ctx.GlobalInt(CacheDatabaseFlag.Name) / 100
		handles = makeDatabaseHandles()

		err     error
		chainDb aysdb.Database
	)
...
func MakeChain(ctx *cli.Context, stack *node.Node, readOnly bool) (chain *core.BlockChain, chainDb aysdb.Database) {
	var err error
	chainDb = MakeChainDatabase(ctx, stack)
...
// new format.
//
// e.g. ays account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// ays --keystore /tmp/mykeystore --lightkdf account new
//
