...
import (
	...
	math2 "github.com/ays/go-ays/common/math"
...
// newAlethGenesisSpec converts a go-ays genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-ays and aleth
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-ays/pull/11039,
...
// newParityChainSpec converts a go-ays genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-ays and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
...
// newPyEthereumGenesisSpec converts a go-ays genesis block into a Parity specific
// chain specification format.
func newPyEthereumGenesisSpec(network string, genesis *core.Genesis) (*pyEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-ays and pyays
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
