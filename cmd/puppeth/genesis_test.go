...
// Tests the go-ays to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_ays.json")
	if err != nil {
...
// Tests the go-ays to Parity chainspec conversion for the Stureby testnet.
