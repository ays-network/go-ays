...
// See https://github.com/ays/EIPs/issues/176 for the test format specification.
...
func MakePreState(db aysdb.Database, accounts core.GenesisAlloc, snapshotter bool) (*snapshot.Tree, *state.StateDB) {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ays/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
