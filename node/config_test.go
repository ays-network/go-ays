...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ays.ipc", false, filepath.Join(os.TempDir(), "ays.ipc")},
		{"data", "ays.ipc", false, "data/ays.ipc"},
		{"data", "./ays.ipc", false, "./ays.ipc"},
		{"data", "/ays.ipc", false, "/ays.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ays.ipc", true, `\\.\pipe\ays.ipc`},
		{"data", "ays.ipc", true, `\\.\pipe\ays.ipc`},
		{"data", `\\.\pipe\ays.ipc`, true, `\\.\pipe\ays.ipc`},
	}
