...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (aysdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (aysdb.Database, func()) {
...
//
// https://github.com/ays/go-ays/pull/15941
...
//
// Details at:
//  - https://github.com/ays/go-ays/issues/18977
//  - https://github.com/ays/go-ays/pull/18988
