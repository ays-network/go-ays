...
// account array.
func checkStateAccounts(t *testing.T, db aysdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db aysdb.Database, root common.Hash) error {
...
func checkStateConsistency(db aysdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(aysdb.Database), srcRoot)
