...
type Tree struct {
	diskdb aysdb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb aysdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
