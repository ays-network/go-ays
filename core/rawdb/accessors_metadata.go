...
func ReadDatabaseVersion(db aysdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db aysdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db aysdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db aysdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
