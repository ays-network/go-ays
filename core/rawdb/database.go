...
import (
	...
	"github.com/ays/go-ays/aysdb/leveldb"
...
func NewDatabase(db aysdb.KeyValueStore) aysdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db aysdb.KeyValueStore, freezer string, namespace string) (aysdb.Database, error) {
...
func NewMemoryDatabase() aysdb.Database {
...
func NewMemoryDatabaseWithCap(size int) aysdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (aysdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (aysdb.Database, error) {
...
func InspectDatabase(db aysdb.Database) error {
