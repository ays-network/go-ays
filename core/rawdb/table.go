...
func NewTable(db aysdb.Database, prefix string) aysdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) aysdb.Iterator {
...
func (t *table) NewBatch() aysdb.Batch {
...
func (b *tableBatch) Replay(w aysdb.KeyValueWriter) error {
