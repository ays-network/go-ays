...
func SetupGenesisBlock(db aysdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db aysdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db aysdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db aysdb.Database) *types.Block {
...
func GenesisBlockForTesting(db aysdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
func DefaultGenesisBlock() *Genesis {
	...
	initReward.Mul(initReward, new(big.Int).SetUint64(35072000))
	return &Genesis{
		...
		Alloc:      map[common.Address]GenesisAccount{
			common.HexToAddress("0xe47357cbf0cf46c4b3df6988e270fff363f37d81"): {
				Balance: initReward,
			},
		},
	}
...
// DeveloperGenesisBlock returns the 'ays --dev' genesis block.
