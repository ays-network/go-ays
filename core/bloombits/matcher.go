...
// that address/topic, and binary AND-ing those vectors toayser.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toayser
				var orVector []byte
...
// the requested retrieval queue to be serviced toayser with other sessions.
//
