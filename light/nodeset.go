...
func (db *NodeSet) Store(target aysdb.KeyValueWriter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements aysdb.KeyValueWriter.
type NodeList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db aysdb.KeyValueWriter) {
	for _, node := range n {
