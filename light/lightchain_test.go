...
func makeHeaderChain(parent *types.Header, n int, db aysdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (aysdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() aysdb.Database {
	return odr.db
}
