...
type testOdr struct {
	...
	sdb, ldb      aysdb.Database
	disable       bool
}

func (odr *testOdr) Database() aysdb.Database {
	return odr.ldb
}
...
type odrTestFn func(ctx context.Context, db aysdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error)

func TestOdrGetBlockLes2(t *testing.T) { testChainOdr(t, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db aysdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrGetReceipts(ctx context.Context, db aysdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrAccounts(ctx context.Context, db aysdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrContractCall(ctx context.Context, db aysdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
