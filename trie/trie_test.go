...
func (s *spongeDb) NewBatch() aysdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) aysdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w aysdb.KeyValueWriter) error { return nil }
