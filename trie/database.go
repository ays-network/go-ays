...
type Database struct {
	diskdb aysdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb aysdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb aysdb.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) DiskDB() aysdb.KeyValueStore {
	return db.diskdb
}
...
// are referenced toayser by database itself.
...
func (db *Database) commit(hash common.Hash, batch aysdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
