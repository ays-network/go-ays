...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db aysdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db aysdb.Database) error {
