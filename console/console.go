...
import (
	...
	"github.com/ays/go-ays/internal/jsre"
	"github.com/ays/go-ays/internal/jsre/deps"
	"github.com/ays/go-ays/internal/web3ext"
...
func (c *Console) initExtensions() error {
	...
	aliases := map[string]struct{}{"ays": {}, "personal": {}}
	for api := range apis {
		if api == "web3" {
			continue
		}
...
func (c *Console) Welcome() {
	message := "Welcome to the ays JavaScript console!\n\n"
