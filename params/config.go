...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/ays/EIPs/issues/150)
	...
	YoloV1Block *big.Int `json:"yoloV1Block,omitempty"` // YOLO v1: https://github.com/ays/EIPs/pull/2657 (Ephemeral testnet)
...
// CheckConfigForkOrder checks that we don't "skip" any forks, ays isn't pluggable enough
