...
//
// Detailed usage document and tutorial available on the go-ays Wiki page:
// https://github.com/ays/go-ays/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// toayser here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two toayser so that if kind.TupleRawName
