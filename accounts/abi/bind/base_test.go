...
func (mc *mockCaller) CallContract(ctx context.Context, call ays.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call ays.CallMsg) ([]byte, error) {
