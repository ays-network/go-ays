...
import (
	...
	"github.com/ays/go-ays/light"
	"github.com/ays/go-ays/params"
	"github.com/ays/go-ays/rlp"
)

type odrTestFn func(ctx context.Context, db aysdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte
...
func odrGetBlock(ctx context.Context, db aysdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrGetReceipts(ctx context.Context, db aysdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrAccounts(ctx context.Context, db aysdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrContractCall(ctx context.Context, db aysdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrTxStatus(ctx context.Context, db aysdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
