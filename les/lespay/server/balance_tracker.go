...
func NewBalanceTracker(ns *nodestate.NodeStateMachine, setup BalanceTrackerSetup, db aysdb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *BalanceTracker {
