...
type accessTestFn func(db aysdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }
func TestBlockAccessLes3(t *testing.T) { testAccess(t, 3, tfBlockAccess) }

func tfBlockAccess(db aysdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db aysdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db aysdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db aysdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
