...
func newLightFetcher(chain *light.LightChain, engine consensus.Engine, peers *serverPeerSet, ulc *ulc, chaindb aysdb.Database, reqDist *requestDistributor, syncFn func(p *serverPeer)) *lightFetcher {
